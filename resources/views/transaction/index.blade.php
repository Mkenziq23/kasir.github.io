    ...
    <div class="col-10">
        <div class="page-utilities">
            <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                ...
                <div class="col-auto">
                    <a class="btn btn-primary" href="/report?{{ request()->getQueryString() }}" id="print">
                                    ...
                                    <tr>
                                        ...
                                        <td class="cell">
                                            <span class="badge bg-{{ $item->status == 'paid' ? 'success' : 'danger' }}">
                                                <i
                                                    class="fa {{ $item->status == 'paid' ? 'fa-check-circle' : 'fa-times-circle' }}"></i>
                                                {{ ucfirst($item->status) }}
                                            </span>
                                        </td>
                                        <td class="cell">IDR. {{ number_format($item->total_transaction, 0, ',', '.') }}
                                        </td>
                                        @can('cashier')
                                            <td class="cell"><a class="btn-sm app-btn-secondary"
                                                    href="/transaction/{{ $item->id }}">View</a></td>
                                        @endcan
                                    </tr>
                                @endforeach
                            </tbody>
