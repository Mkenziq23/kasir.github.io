...
@section('container')
    ...
    <div class="container-fluid p-4">
        <div class="row">
            <!-- Left Side Menu (All Menus) -->
            <div class="col-md-8 p-0 d-flex flex-column">
                <div class="hd-menu d-flex align-items-center justify-content-between shadow bg-white p-3">
                ...
                <div class="wp-menu d-flex flex-column">
                    ...
                    <!-- Tab Content -->
                    <div class="tab-content menu-tab overflow-auto" style="height: 85%" data-aos="fade-up"
                        data-aos-delay="300">
                        <!-- Makanan Tab -->
                        <div class="tab-pane fade active show" id="food">
                            <div class="menu-content pe-4 ps-4 d-flex flex-wrap justify-content-between">
                                @foreach ($makanan as $food)
                                    <div class="menu-item-cart rounded shadow d-flex align-items-center justify-content-between"
                                        ...
                                        <div class="d-flex justify-content-center flex-column ms-2">
                                            <div class="product">
                                                <h5 class="text-break" style="font-size: 16px; width: 100px;">
                                                    {{ $food->name }}</h5>
                                            ...
                                            <div class="qty d-flex mt-3">
                                                ...
                                                <div class="qty-numbers me-3 ms-3">0</div>
                            ...
                            <div class="menu-content pe-4 ps-4 d-flex flex-wrap justify-content-between">
                                @foreach ($minuman as $drink)
                                    <div class="menu-item-cart rounded shadow d-flex align-items-center justify-content-between"
                                        ...
                                        <img class="img-fluid" src="{{ asset('storage/' . $drink->picture) }}"
                                            alt="" width="150">
                                        <div class="d-flex justify-content-center flex-column ms-2">
                                            <div class="product">
                                                <h5 class="text-break" style="font-size: 16px; width: 100px;">
                                                    {{ $drink->name }}</h5>
                                                <h6 class="text-muted" style="font-size: 13px;">
                                                    {{ number_format($drink->price, 0, ',', '.') }}</h6>
                                            </div>
                                            <div class="qty d-flex mt-3">
                                                <button class="border-0 rounded bg-transparent RemovetoCart"><i
                                                        class="fa-solid fa-minus" style="font-size: 12px;"></i></button>
                        ...
                        <div class="tab-pane fade" id="dessert">
                            <div class="menu-content pe-4 ps-4 d-flex flex-wrap justify-content-between">
                                @foreach ($camilan as $dessert)
                                    <div class="menu-item-cart rounded shadow d-flex align-items-center justify-content-between"
                                        data-id="{{ $dessert->id }}" style="margin-bottom: 7%;">
                                        <img class="img-fluid" src="{{ asset('storage/' . $dessert->picture) }}"
                                            alt="" width="150">
                                        <div class="d-flex justify-content-center flex-column ms-2">
                                            <div class="product">
                                                <h5 class="text-break" style="font-size: 16px; width: 100px;">
                                                    {{ $dessert->name }}</h5>
                                                <h6 class="text-muted" style="font-size: 13px;">
                                                    {{ number_format($dessert->price, 0, ',', '.') }}</h6>
                                            </div>
                                            <div class="qty d-flex mt-3">
                                                <button class="border-0 rounded bg-transparent RemovetoCart"><i
                                                        class="fa-solid fa-minus" style="font-size: 12px;"></i></button>
            ...
            <div class="col-md-4 p-0 d-flex flex-column">
                ...
                <div class="cart-body d-flex flex-column justify-content-between" style="height: 780px;">
                    <div class="d-flex justify-content-between p-3 align-items-center">
                        ...
                        <h6 class="fw-semibold text-white me-2" style="font-size: 13px;">{{ now()->format('Y-m-d') }}
                        </h6>
                    </div>
                    ...
                    <form action="/transaction" method="POST" class="align-self-center p-0 m-0" style="width: 90%;">
                        ...
                        <div class="cart-payment p-2 d-flex flex-column rounded">
                            ...
                            {{-- <div class="ppn d-flex justify-content-between align-items-center p-2">
